	...
	$(function() {
		...
		$('#frmMarkdown').on('submit', function(ev) {
			...
			$.ajax({
				...
				dataType: 'html',
				ajaxSend: $results.append('<img src="/img/ajax-loader.gif" alt="loading..." class="loader" />'),
	...
	$(function() {
		...
		$('#frmTidy').on('submit', function(ev) {
			...
			$.ajax({
				...
				dataType: 'html',
				ajaxSend: $('#frmTidy').append('<img src="/img/ajax-loader.gif" alt="loading..." class="loader" />')
			})
			.done(function(data) {
				$textProcessed.html(data);
				$textProcessed.find('table').addClass('table').addClass('table-bordered');
	...
	$(function() {
		...
		$('#frmEntitize').on('submit', function(ev) {
			...
			$.ajax({
				...
				dataType: 'html',
				ajaxSend: $('#frmEntitize').append('<img src="/img/ajax-loader.gif" alt="loading..." class="loader" />')
			})
			.done(function(data) {
