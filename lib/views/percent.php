<article>
	<h1>Percent %</h1>
	<p>Yep, those pesky percentages.</p>

<!--
http://mathematics.blurtit.com/q845591.html
http://www.math.com/students/calculators/source/3percent.htm
http://www.squidoo.com/how-to-calculate-percentages
-->
	...
	<form id="frmPercent">
		<fieldset class="bordered">
			<div class="row control-group">
				...
				<div class="span2">
					<output id="result1" class="pull-right well text-xlarge">0</output>
				</div>
			</div>
		</fieldset>
		<fieldset class="bordered">
			<div class="row control-group">
				...
				<div class="span2">
					<output id="result2" class="pull-right well text-xlarge">0</output>
				</div>
			</div>
		</fieldset>
		<fieldset class="bordered">
			<div class="row control-group">
				...
				<div class="span2">
					<output id="result3" class="pull-right well text-xlarge">0</output>
				</div>
			</div>
		</fieldset>
	</form>
